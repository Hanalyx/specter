...
| [103](SSRB-103.md) | Multi-stream evidence in ingest and coverage | ACCEPT (foundation) | 2026-08-24 for the foundation; policies TBD |
...
- **ACCEPT (scope)**: only the named scope is adopted; the rest of the brief stays open. The brief says which parts and why. Read it before assuming any part is settled
