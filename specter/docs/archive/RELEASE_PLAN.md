> **⚠ Archived — stale content.** This document was written pre-v0.3.0 and was not maintained past that version. Current release status lives in [CHANGELOG.md](../../CHANGELOG.md). Kept here for historical reference only.
